...
def create_widgets():
    ...
    perc = Button(root, text='%', bd=3,  font=("Helvetica", 25, "bold"), width=4, height=2, command=lambda : click_button('%'))
    perc.grid(row=1, column=2, padx=3, pady=3)

    d_button = Button(root, text='/', bd=3,  font=("Helvetica", 25, "bold"), width=4, height=2, command=lambda : click_button('/'))
    d_button.grid(row=1, column=3, padx=3, pady=3)

    seven = Button(root, text='7', bd=3,  font=("Helvetica", 25, "bold"), width=4, height=2, command=lambda : click_button(7))
    seven.grid(row=2, column=0, padx=3, pady=3)

    eight = Button(root, text='8', bd=3,  font=("Helvetica", 25, "bold"), width=4, height=2, command=lambda : click_button(8))
    eight.grid(row=2, column=1, padx=3, pady=3)

    nine = Button(root, text='9', bd=3,  font=("Helvetica", 25, "bold"), width=4, height=2, command=lambda : click_button(9))
    nine.grid(row=2, column=2, padx=3, pady=3)

    m_button = Button(root, text='*', bd=3,  font=("Helvetica", 25, "bold"), width=4, height=2, command=lambda : click_button('*'))
    m_button.grid(row=2, column=3, padx=3, pady=3)

    four = Button(root, text='4', bd=3,  font=("Helvetica", 25, "bold"), width=4, height=2, command=lambda : click_button(4))
    four.grid(row=3, column=0, padx=3, pady=3)

    five = Button(root, text='5', bd=3,  font=("Helvetica", 25, "bold"), width=4, height=2, command=lambda : click_button(5))
    five.grid(row=3, column=1, padx=3, pady=3)

    four = Button(root, text='6', bd=3,  font=("Helvetica", 25, "bold"), width=4, height=2, command=lambda : click_button(6))
    four.grid(row=3, column=2, padx=3, pady=3)

    B_D = Button(root, text='-', bd=3,  font=("Helvetica", 25, "bold"), width=4, height=2, command=lambda : click_button('-'))
    B_D.grid(row=3, column=3, padx=3, pady=3)

    one = Button(root, text='1', bd=3,  font=("Helvetica", 25, "bold"), width=4, height=2, command=lambda : click_button(1))
    one.grid(row=4, column=0, padx=3, pady=3)

    two = Button(root, text='2', bd=3,  font=("Helvetica", 25, "bold"), width=4, height=2, command=lambda : click_button(2))
    two.grid(row=4, column=1, padx=3, pady=3)

    three = Button(root, text='3', bd=3,  font=("Helvetica", 25, "bold"), width=4, height=2, command=lambda : click_button(3))
    three.grid(row=4, column=2, padx=3, pady=3)

    a_button = Button(root, text='+', bd=3,  font=("Helvetica", 25, "bold"), width=4, height=2, command=lambda : click_button('+'))
    a_button.grid(row=4, column=3, padx=3, pady=3)

    zero = Button(root, text='0', bd=3,  font=("Helvetica", 25, "bold"), width=10, height=2, command=lambda : click_button(0))
    zero.grid(row=5, column=0, padx=3, pady=10, columnspan=2)

    decimalp_b = Button(root, text='.', bd=3,  font=("Helvetica", 25, "bold"), width=4, height=2, command=lambda : click_button('.'))
    decimalp_b.grid(row=5, column=2, padx=3, pady=10)

    equal_button = Button(root, text='=', bd=3,  font=("Helvetica", 25, "bold"), width=4, height=2, command=calculateResult)
